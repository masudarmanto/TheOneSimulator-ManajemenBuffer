...
public class SnWManajemenBuffer extends ActiveRouter {
	...
	public SnWManajemenBuffer(Settings s) {
		super(s);
	 ...
	 */
	protected SnWManajemenBuffer(SnWManajemenBuffer r) {
		super(r);
	...
	@Override
	public SnWManajemenBuffer replicate() {
		return new SnWManajemenBuffer(this);
	}
}
